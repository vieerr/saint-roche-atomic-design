...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8 \textwidth, height=10cm, keepaspectratio]{home_screen.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8 \textwidth, height=12cm, keepaspectratio]{anexos/err_ejecucion.png}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8 \textwidth, height=10cm, keepaspectratio]{anexos/err2.png}
\end{figure}
